...
HD_PWD='C:/home/valerix/MaxIV/year2021/xilinxworks/pid/pid_panda/netlist/ip_catalog/pidsg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pidsg_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pidsg_bd_wrapper.tcl
