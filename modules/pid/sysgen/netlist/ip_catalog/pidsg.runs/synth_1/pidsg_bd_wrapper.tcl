...
synth_design -top pidsg_bd_wrapper -part xc7z030sbg485-1 -mode out_of_context
...
write_checkpoint -force -noxdef pidsg_bd_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file pidsg_bd_wrapper_utilization_synth.rpt -pb pidsg_bd_wrapper_utilization_synth.pb"
