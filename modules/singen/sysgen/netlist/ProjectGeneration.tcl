...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{singen_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{singen.vhd} -lib {xil_defaultlib}}
		{{singen_clock.xdc}}
		{{singen.xdc}}
	}
	set SimPeriod 8e-09
	...
	set TargetDir {C:/home/valerix/MaxIV/year2021/xilinxworks/singen/netlist}
	set TopLevelModule {singen}
	...
	dict set TopLevelPortInterface reset_n DatFile {singen_reset_n.dat}
	...
	dict set TopLevelPortInterface rational_freq DatFile {singen_rational_freq.dat}
	...
	dict set TopLevelPortInterface sine_out DatFile {singen_sine_out.dat}
	...
	dict set TopLevelPortInterface clk ClockDomain {singen}
