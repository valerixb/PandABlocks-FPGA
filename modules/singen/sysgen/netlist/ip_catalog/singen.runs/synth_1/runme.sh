...
HD_PWD='C:/home/valerix/MaxIV/year2021/xilinxworks/singen/netlist/ip_catalog/singen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singen_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singen_bd_wrapper.tcl
