...
HD_PWD='C:/home/valerix/MaxIV/year2021/xilinxworks/singen/netlist/ip_catalog/singen.runs/singen_bd_singen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singen_bd_singen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singen_bd_singen_1_0.tcl
