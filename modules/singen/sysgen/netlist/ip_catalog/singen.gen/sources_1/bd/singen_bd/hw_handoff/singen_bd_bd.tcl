...
################################################################
# This is a generated script based on design: singen_bd
#
...
proc create_root_design { parentCell } {
  ...
  set reset_n [ create_bd_port -dir I -from 0 -to 0 -type data reset_n ]
  set sine_out [ create_bd_port -dir O -from 31 -to 0 -type data sine_out ]

  # Create instance: singen_1, and set properties
  set singen_1 [ create_bd_cell -type ip -vlnv MaxIV:Panda_SysGen:singen:1.0 singen_1 ]

  # Create port connections
  connect_bd_net -net ampl_1 [get_bd_ports ampl] [get_bd_pins singen_1/ampl]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins singen_1/clk]
